      ...
      <main className="flex flex-1 items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
        <Card className="w-full max-w-md">
          <CardHeader className="space-y-1">
            <CardTitle className="text-center text-2xl font-bold">Join Quiz</CardTitle>
            <CardDescription className="text-center">Enter your name and the quiz code to start</CardDescription>
          </CardHeader>
          <CardContent>
            {error && (
          ...
          <CardFooter className="flex justify-center border-t bg-gray-50 p-4">
            <p className="text-sm text-gray-500">
              For demo, use quiz code: <span className="font-semibold">JS101</span>
            </p>
          </CardFooter>
        </Card>
      </main>
